...
class CollectionController extends Controller
{
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'View Inlis Sync Collections Manage');
	...
	{
		$this->pageTitle = Yii::t('phrase', 'View View Inlis Sync Collections');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	{
		$model = ViewInlisSyncCollections::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='view-inlis-sync-collections-form') {
