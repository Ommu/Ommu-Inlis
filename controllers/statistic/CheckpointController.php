...
class CheckpointController extends Controller
{
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'View Inlis Sync Checkpoints Manage');
	...
	{
		$this->pageTitle = Yii::t('phrase', 'View View Inlis Sync Checkpoints');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	{
		$model = ViewInlisSyncCheckpoints::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='view-inlis-sync-checkpoints-form') {
