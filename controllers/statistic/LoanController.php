...
class LoanController extends Controller
{
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'View Inlis Sync Collectionloans Manage');
	...
	{
		$this->pageTitle = Yii::t('phrase', 'View View Inlis Sync Collectionloans');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	{
		$model = ViewInlisSyncCollectionloans::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='view-inlis-sync-collectionloans-form') {
