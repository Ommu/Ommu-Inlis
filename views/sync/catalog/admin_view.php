...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		...
		array(
			...
			'value'=>!in_array($model->ApproveDateOPAC, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')) ? $this->dateFormat($model->ApproveDateOPAC, true) : '-',
		),
		array(
			'name'=>'IsOPAC',
			'value'=>$model->IsOPAC,
		...
		array(
			'name'=>'tanggal',
			'value'=>!in_array($model->tanggal, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')) ? $this->dateFormat($model->tanggal, true) : '-',
		),
	),
)); ?>