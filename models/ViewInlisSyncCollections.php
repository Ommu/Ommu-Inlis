 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_inlis_sync_collections".
 *
 * The followings are the available columns in table '_view_inlis_sync_collections':
...
class ViewInlisSyncCollections extends CActiveRecord
{
	 ...
	 * @return ViewInlisSyncCollections the static model class
	 */
	...
	{
		return '_view_inlis_sync_collections';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('date_key, collections', 'safe', 'on'=>'search'),
		);
	}
